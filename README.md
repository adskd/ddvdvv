...
如出现错误，可以多尝试几次，待部署完成后页面底部会显示Your app was successfully deployed  
  ...
  * 点击Open app跳转[欢迎页面](/etc/CADDYIndexPage.md)域名即为heroku分配域名，格式为`appname.heroku.com`，用于客户端  
  * 默认协议密码为$UUID，WS路径为$UUID-[vmess|vless|trojan|ss|socks]格式
  
### 客户端
* **务必替换所有的appname.heroku.com为heroku分配的项目域名**  
* **务必替换所有的535cdd6a-52e6-49cf-a3a3-fc51d03753a7为部署时设置的AUUID**  
...
* 代理协议：vless 或 vmess
* 地址：appname.heroku.com
* 端口：443
* 默认UUID：535cdd6a-52e6-49cf-a3a3-fc51d03753a7
* 加密：none
* 传输协议：ws
* 伪装类型：none
* 路径：/535cdd6a-52e6-49cf-a3a3-fc51d03753a7-vless // 默认vless使用/$uuid-vless，vmess使用/$uuid-vmess
* 底层传输安全：tls
```
</details>
...
* 客户端下载: https://github.com/p4gefau1t/trojan-go/releases
{
    ...
    "local_port": 1080,
    "remote_addr": "appname.heroku.com",
    "remote_port": 443,
    "password": [
        "535cdd6a-52e6-49cf-a3a3-fc51d03753a7"
    ],
    "websocket": {
        "enabled": true,
        "path": "/535cdd6a-52e6-49cf-a3a3-fc51d03753a7-trojan",
...
```js
const SingleDay = 'appname.heroku.com'
const DoubleDay = 'appname.heroku.com'
addEventListener(
    "fetch",event => {
